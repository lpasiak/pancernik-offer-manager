...
ALLEGRO_CLIENT_ID_SANDBOX = os.getenv('ALLEGRO_CLIENT_ID_SANDBOX')
ALLEGRO_API_URL_SANDBOX = os.getenv('ALLEGRO_API_URL_SANDBOX')


ALLEGRO_API_VERSION = 'application/vnd.allegro.public.v1+json'

# ALLEGRO_TOKEN_SANDBOX = os.getenv('ALLEGRO_TOKEN_SANDBOX')
